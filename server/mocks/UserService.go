...
func (_m *UserService) GetUserByEmail(email string) (*models.User, error) {
	ret := _m.Called(email)
...
func (_m *UserService) GetUserByID(id int) (*models.User, error) {
	ret := _m.Called(id)
...
func (_m *UserService) GetUserByUsername(username string) (*models.User, error) {
...
func (_m *UserService) RegisterUser(user *models.User) error {
	ret := _m.Called(user)
